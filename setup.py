...
setup(name='%s_%s' % (PREFIX, MODULE),
    ...
    url='https://github.com/NaN-tic/trytond-stock_assign_group_buttons',
    download_url='https://github.com:nantic/trytond-stock_assign_group_buttons.git',
    ...
    project_urls = {
       "Source Code": 'https://github.com:NaN-tic/trytond-stock_assign_group_buttons.git'
    },
    classifiers=[
